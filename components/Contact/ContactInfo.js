                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4 col-md-12">
                            <div className="contact-address">
                                ...
                                <p>{contactUsInfo.data.attributes.info}</p>

                                <ul className="address-info">
                                    {/* <li>
                                        <i className="ri-customer-service-line"></i>
                                        <a href={`tel:${contactUsInfo.data.attributes.phone_number}`}>{contactUsInfo.data.attributes.phone_number}</a>
                                    </li> */}

                                    <li>
                                        <i className="ri-global-line"></i>
                                        <a href={`mailto:${contactUsInfo.data.attributes.email}`}>{contactUsInfo.data.attributes.email}</a>
                                    </li>
                        ...
                        <div className="col-lg-8 col-md-12">
                            <div id="map">
                                <iframe src={contactUsInfo.data.attributes.google_map_embed_url_only}></iframe>
                            </div>
                        </div>
                    </div>
                </div>
